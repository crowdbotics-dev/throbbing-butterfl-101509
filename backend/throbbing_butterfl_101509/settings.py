"""
Django settings for throbbing_butterfl_101509 project.
...
ROOT_URLCONF = 'throbbing_butterfl_101509.urls'
...
WSGI_APPLICATION = 'throbbing_butterfl_101509.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "throbbing_butterfl_101509 API",
    "DESCRIPTION": "API documentation for throbbing_butterfl_101509 App",
    "VERSION": "v1",
}
