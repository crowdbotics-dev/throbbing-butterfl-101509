...
## Project Structure
    ...
    ├── throbbing_butterfl_101509  # Django project configurations
...
1. Clone this repo and `cd throbbing_butterfl_101509`
...
2. Clone this repo and `cd throbbing_butterfl_101509`
